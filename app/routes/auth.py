...
def seed_database(db: Session = Depends(get_db)):
    ...
    admin = models.User(email="admin@bodhrik.com", name="Admin User", hashed_password=password_hash, role="admin")
    teacher1 = models.User(email="teacher1@bodhrik.com", name="Teacher One", hashed_password=password_hash, role="teacher")
    teacher2 = models.User(email="teacher2@bodhrik.com", name="Teacher Two", hashed_password=password_hash, role="teacher")
    parent1 = models.User(email="parent1@bodhrik.com", name="Parent One (John & Jane)", hashed_password=password_hash, role="parent")
    parent2 = models.User(email="parent2@bodhrik.com", name="Parent Two (Bob)", hashed_password=password_hash, role="parent")
    ...
    return {"message": "Database successfully seeded with 1 Admin, 2 Teachers, 2 Parents, 3 Students, and 3 Sessions."}
